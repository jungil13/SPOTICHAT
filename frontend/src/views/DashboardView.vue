<template>
  <section class="app-main">
    <div class="min-h-screen flex bg-zinc-900 text-white">
      <!-- Left Sidebar -->
      <div class="inset-y-1 right-z-10 w-1/2 bg-zinc-900">
        <section class="w-full md:w-7/6 h-full md:h-7/6 py-6 mx-4 md:mx-0">
          <aside class="inset-y-1 right-z-10 w-1/4 fixed">
            <div class="w-full md:w-7/6 h-full md:h-7/6 py-6 bg-zinc-800 mx-4 md:mx-0">
              <div class="flex items-center justify-center mb-4">
                <i class="fas fa-music mr-3 text-xl text-green-400"></i>
                <h2 class="text-2xl font-extrabold mb-4">My Playlist</h2>
              </div>
              <ArtistView />
              <div class="flex items-center justify-center py-3">
                <i class="fas fa-microphone text-2xl text-green-400"></i>
                <h2 class="text-2xl font-extrabold px-4 flex justify-center">Top Artist</h2>
              </div>
              <ArtistaView />
            </div>
          </aside>
      ...
      <!-- Main Content -->
      <div class="p-4 w-full items-center">
        ...
        <div class="flex justify-center">
          <div class="flex w-30">
            <input v-model="searchQuery" type="text" placeholder="Search music . . ."
              class="flex-1 bg-gray-800 hover:bg-zinc-700 border border-white text-white rounded-l-full px-4 py-2 font-semibold text-md">
            <button @click="search"
        ...
        <!-- Top Songs Section -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6 mt-8 mb-6">
      ...
      <!-- Right Drawer -->
      <div class="inset-y-0 right-0 z-10 w-1/2">

      </div>
      <div class="inset-y-0 right-0 z-10 w-1/4 sm:w-1/4 fixed">
        <!-- <transition name="slide">
          <div v-if="isDrawerOpen" class="bg-zinc-800 border-l border-gray-700"> -->
