<template>
  <div class="flex flex-col flex-grow bg-neutral-800 shadow-xl rounded-lg overflow-hidden border border-gray-400">
    <header class="bg-zinc-900 py-4 border border-stone-500">
      <div class="flex items-center justify-between">
        <RouterLink class="text-2xl font-extrabold cursor-pointer font-sans text-white ml-6" to="/dashboard">
          <i class="fas fa-envelope mr-2 text-3xl text-green-400"></i>
          <span class="text-white">CHATIFY</span>
        </RouterLink>
        <div class="flex items-center mr-6">
          <i class="fas fa-phone-alt mr-4 text-white text-2xl cursor-pointer px-4"></i>
          <i class="fas fa-video mr-4 text-white text-2xl cursor-pointer px-4"></i>
        </div>
      </div>
    </header>
    ...
    <div class="bg-zinc-900 p-4 flex items-center space-x-2 border border-stone-500">
